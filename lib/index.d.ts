...
import { optionalAuthentication, requiredAuthentication, setupPassport, AuthenticatedRequest } from './swizzle-passport';
...
export { getSecret, analyticsMiddleware, setupPassport, connectDB, UID, optionalAuthentication, requiredAuthentication, AuthenticatedRequest, init as initDb, dbProxy as db, saveFile, deleteFile, getFileUrl, addUserToFile, removeUserFromFile, storageHandler, getUser, editUser, createUser, searchUsers, signTokens, refreshTokens };
